...
(function ($) {
  ...
  // Static method.
  $[ pluginName ] = function ( el, numberOfImages, options ) {
    var base = this,
        timer = 0,
        index = 0,
        images = [],
    ...
    base.init = function() {
        ...
        base.options = $.extend( {}, $[ pluginName ].options, options );
  ...
  // Collection method.
  $.fn[ pluginName ] = function( numberOfImages, options ){
      return this.each(function(){
          ( new $[ pluginName ]( this, numberOfImages, options ) );
      });
  };
